...
public class Conference {
	...
	public String toString() {
		return "Conference [city=" + city + ", country=" + country + ", countryCode=" + countryCode + ", currency="
				+ currency + ", dateFrom=" + dateFrom + ", dateTo=" + dateTo + ", dialingCode=" + dialingCode
				+ ", field=" + field + ", idconference=" + idconference + ", title=" + title + "]";
	}
